...
function AllCatrgories() {
  return (
    <Box p={{base:5,md:10}} borderRadius='10px'>
      <Heading color="gray.400" display={'inline-flex'} alignItems='center'><Link to={'/'}><MdArrowBackIos/></Link>All Categories</Heading>

      <SimpleGrid templateColumns={{base:'repeat(3, 1fr)',md:'repeat(5, 1fr)'}} gap={6} bg='gray.50' my={{base:10,md:15}} py={{base:5,md:10}}>
